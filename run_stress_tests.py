...
class StressTestRunner:
    ...
    def run_quick_test(self) -> Dict[str, Any]:
        ...
        try:
            # 运行快速幂等性测试
            cmd = [
                sys.executable, "quick_idempotency_test.py",
                "--url", self.base_url,
    ...
    def run_idempotency_stress_test(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                sys.executable, "idempotency_monitoring_stress_test.py",
                "--url", self.base_url,
                "--secret", self.webhook_secret,
                "--concurrent", str(self.test_config["idempotency_concurrent"]),
                "--requests", str(self.test_config["idempotency_requests"]),
                "--duplicate-rate", str(self.test_config["idempotency_duplicate_rate"])
            ]
    ...
    def run_metrics_analysis(self) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                sys.executable, "metrics_analyzer.py",
                "--url", self.base_url,
                "--duration", str(self.test_config["metrics_duration_minutes"]),
                "--interval", str(self.test_config["metrics_interval_seconds"])
            ]
    ...
    def run_comprehensive_stress_test(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                sys.executable, "performance-test.py",
                "--url", self.base_url,
                "--requests", str(self.test_config["comprehensive_requests"]),
                "--concurrency", str(self.test_config["comprehensive_concurrent"]),
