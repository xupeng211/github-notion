...
class TestRunner:
    ...
    def test_architecture_validation(self):
        ...
        success, stdout, stderr = self.run_command([
            sys.executable, "scripts/validate_fixes.py"
        ])
    ...
    def test_unit_functions(self):
        ...
        try:
            from app.service import verify_gitee_signature, event_hash_from_bytes
    ...
    async def test_async_functions(self):
        ...
        try:
            ...
            try:
                success, page_id = await async_notion_upsert_page({
                    "title": "Test Issue",
                    "number": 123
                })
