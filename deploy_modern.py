...
class ModernDeployer:
    ...
    def transfer_files(self):
        ...
        # 创建应用目录
        if not self.run_ssh_command("sudo mkdir -p /opt/github-notion-sync && sudo chown ubuntu:ubuntu /opt/github-notion-sync", "创建应用目录"):
            return False
...
def main():
    ...
    parser.add_argument("--environment", "-e", default="production", choices=["development", "staging", "production"], help="部署环境")
