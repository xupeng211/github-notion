...
def log_security_event(event_type: str, client_ip: str, details: str, severity: str = "warning"):
    """记录安全相关事件的审计日志"""
...
def log_system_event(event_type: str, details: str, metadata: Optional[Dict[str, Any]] = None):
    """记录系统事件的审计日志"""
